...
const jsonFiles = [
    ...
    {collectionName: 'Orders', filePath: 'JSONs/Orders.json' },
    {collectionName: 'Clients', filePath: 'JSONs/Clients.json' },
    {collectionName: 'Dishes', filePath: 'JSONs/Dishes.json' },
    {collectionName: 'Suppliers', filePath: 'JSONs/Suppliers.json' },
    {collectionName: 'Carts', filePath: 'JSONs/Carts.json' },
    {collectionName: 'Deliveries', filePath: 'JSONs/Deliveries.json' }
];
...
async function main() {
    const uri = "mongodb://localhost:27018/"; // replace with your MongoDB connection string (propably same but with 27017)
